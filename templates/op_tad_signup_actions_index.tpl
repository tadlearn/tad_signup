<h2 class="my"><{$smarty.const._MD_TAD_SIGNUP_ACTION_LIST}></h2>

<table class="table table-bordered">
    <thead>
        <tr>
            <th nowrap class="c"><{$smarty.const._MD_TAD_SIGNUP_TITLE}></th>
            <th nowrap class="c"><{$smarty.const._MD_TAD_SIGNUP_ACTION_DATE}></th>
            <th nowrap class="c"><{$smarty.const._MD_TAD_SIGNUP_END_DATE_COL}></th>
            <th nowrap class="c"><{$smarty.const._MD_TAD_SIGNUP_NUMBER_OF_APPLIED}></th>
            ...
            <tr>
                ...
                <td>
                    <{if $smarty.session.can_add && ($action.uid==$now_uid || $smarty.session.tad_signup_adm)}>
                        <a href="<{$xoops_url}>/modules/tad_signup/index.php?op=tad_signup_actions_edit&id=<{$action.id}>" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> <{$smarty.const._EDIT}></a>
